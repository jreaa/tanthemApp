<template>
  <div>
    <div style="margin-bottom:50px!important" class="d-flex align-items-center font-weight-bold my-2 mb-4" bis_skin_checked="1">
        <!--begin::Item-->
        <router-link
                :to="{ name: 'pagos.index' }"  class="opacity-75 hover-opacity-100" bis_skin_checked="1">
          <i class="flaticon2-shelter"></i>
        </router-link>
        <!--end::Item-->
        <!--begin::Item-->
        <span class="label label-dot label-sm bg-black opacity-75 mx-3"></span>
        <a href="/" style="font-size: 13!important" class="opacity-75 hover-opacity-100" bis_skin_checked="1">Pagos</a>
        <!--end::Item-->
    </div>
    <h3 class="mt-4">Tipo Registro</h3>
    <br />
    <div class="card card-custom">
      <div class="card-header flex-wrap py-5">
        <div class="card-title">
          <h3 class="card-label">
            Datos de los tipo registro Asociado
    ...
    margin-left: auto!important;"
                    ...
                    <div class="alert-text">
                        No hay tipo registro registrados 
                    </div>
                    </div>
...
export default {
  ...
  methods: {
    getEstados(page = 1,table = "name") {
      ...
      axios.get("/api/pagos?page=" + page + "&paginate=" + this.paginate + "&q=" + this.search + "&sort=" + sort + "&table=" + table).then((response) => {
    ...
    getCliente(id) {
      axios.get("/api/pagos/" + id).then((response) => {
    ...
    updateEstado() {
      this.clientFormLoading = true;
      axios
        .put("/api/pagos/" + this.idCliente, this.form)
        .then((response) => {
