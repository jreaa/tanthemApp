<template>
  <div>
    <div style="margin-bottom:50px!important" class="d-flex align-items-center font-weight-bold my-2 mb-4" bis_skin_checked="1">
        ...
        <a href="/" style="font-size: 13!important" class="opacity-75 hover-opacity-100" bis_skin_checked="1">Tipo Ingresos</a>
        <!--end::Item-->
    </div>
    <h3 class="mt-4">Tipo Ingresos</h3>
    <br />
    <div class="card card-custom">
      <div class="card-header flex-wrap py-5">
        <div class="card-title">
          <h3 class="card-label">
            Datos de los tipo ingresos asociado
    ...
    margin-left: auto!important;"
                    ...
                    <div class="alert-text">
                        No hay tipo ingresos registrados 
                    </div>
                    </div>
...
export default {
  ...
  methods: {
    getEstados(page = 1,table = "name") {
      ...
      axios.get("/api/tingresos?page=" + page + "&paginate=" + this.paginate + "&q=" + this.search + "&sort=" + sort + "&table=" + table).then((response) => {
    ...
    getCliente(id) {
      axios.get("/api/tingresos/" + id).then((response) => {
    ...
    updateEstado() {
      this.clientFormLoading = true;
      axios
        .put("/api/tingresos/" + this.idCliente, this.form)
        .then((response) => {
